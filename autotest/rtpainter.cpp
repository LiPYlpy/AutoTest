...
RTPainter::RTPainter(QGraphicsItem *parent, Qt::WindowFlags wFlags) :QChart(QChart::ChartTypeCartesian, parent, wFlags)
{
    m_chart = new QChart;
...
QList<QPointF> RTPainter::setdata()
{
...
void RTPainter::addSeries(QList<QPointF> &data)
{
...
void RTPainter::connectMarkers()
{
    // Connect all markers to handler
    foreach(QLegendMarker* marker, m_chart->legend()->markers()) {
        // Disconnect possible existing connection to avoid multiple connections
        QObject::disconnect(marker, &QLegendMarker::clicked, this, &RTPainter::handleMarkerClicked);
        QObject::connect(marker, &QLegendMarker::clicked, this, &RTPainter::handleMarkerClicked);
    }
}

void RTPainter::disconnectMarkers()
{
    foreach(QLegendMarker* marker, m_chart->legend()->markers()) {
        QObject::disconnect(marker, &QLegendMarker::clicked, this, &RTPainter::handleMarkerClicked);
    }
...
void RTPainter::handleMarkerClicked()
{
...
void RTPainter::timerEvent(QTimerEvent *event)
{
